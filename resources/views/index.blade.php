            ...
            <div class="device-mockup iphone6_plus portrait white">
              <div class="device">
                <div class="screen">
                  ...
                  <img src="{{ asset('assets') }}/img/demo-screen-1.jpg" class="img-fluid" alt="">
                </div>
                <div class="button">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 mx-auto">
          ...
          <div class="badges">
            <a class="badge-link" href="#"><img src="{{ asset('assets') }}/img/google-play-badge.svg" alt=""></a>
            <a class="badge-link" href="#"><img src="{{ asset('assets') }}/img/app-store-badge.svg" alt=""></a>
          </div>
        </div>
      </div>
    </div>
